...
(function($) {
  ...
  ColorPicker.prototype = {
    generate: function() {
      ...
      if (!this.$colorPicker) {
        ...
        this.$skintoneColorPalette = this._createPalette('skin', $.fn.wColorPicker.skintoneColors);
        ...
        .append(this.$skintoneColorPalette);
    ...
    setMode: function(mode) {
      ...
      if (mode !== 'flat') {
		...
		this.$skintoneColorPalette.bind('click', func);
      }
  ...
  $.fn.wColorPicker.mixedColors = wColorPickerSaturationValueMapper([

["#2F4F4F", "#708090", "#778899", "#696969", "#A9A9A9", "#D3D3D3", "#DCDCDC", "#B0C4DE" , "#00008B", "#191970", "#483D8B", "#4B0082", "#0000CD", "#7B68EE", "#4169E1", "#6495ED"],
["#008BBB", "#4682B4", "#1E90FF", "#00BFFF", "#87CEFA", "#87CEEB", "#ADD8E6", "#00FFFF" , "#5F9EA0", "#20B2AA", "#66CDAA", "#00CED1", "#48D1CC", "#40E0D0", "#B0E0E6", "#AFEEEE"],
["#6B8E23", "#556B2F", "#006400", "#228B22", "#2E8B57", "#3CB371", "#32CD32", "#9ACD32" , "#7FFFD4", "#00FA9A", "#00FF7F", "#7CFC00", "#7FFF00", "#ADFF2F", "#90EE90", "#98FB98"],
["#8B008B", "#6A5ACD", "#8A2BE2", "#9400D3", "#9932CC", "#BA55D3", "#9370DB", "#8FBC8F" , "#8B0000", "#8B4513", "#A52A2A", "#B22222", "#A0522D", "#CD5C5C", "#D2691E", "#BDB76B"],
["#DC143C", "#FF1493", "#FF69B4", "#FF00FF", "#DA70D6", "#EE82EE", "#DDA0DD", "#D8BfD8" , "#BC8F8F", "#C71585", "#DB7093", "#E9967A", "#F08080", "#FFA07A", "#FFB6C1", "#FFC0CB"],
["#FF4500", "#FF6347", "#FF4F50", "#FA8072", "#FF8C00", "#FFA500", "#F4A460", "#E6E6FA" , "#B8860B", "#CD853F", "#DAA520", "#D2B48C", "#DEB887", "#FFD700", "#FFE4E1", "#E0FFFF"],
["#F0E68C", "#EEE8AA", "#FAFAD2", "#FFFACD", "#F5F5DC", "#FFF8DC", "#FFFFE0", "#FFDAB9" , "#F5DEB3", "#FFDEAD", "#FFE4B5", "#FFE4C4", "#FFEBCD", "#FFEFD5", "#FAEBD7", "#FFF0F5"],
["#FAF0e0", "#FFEEE0", "#FDF5E6", "#F0F8FF", "#F8F8FF", "#F0FFFF", "#F5FFFA", "#F5F5F5" , "#F8F8FF", "#FFFAF0", "#FFFFF0", "#FFFAFA", "#F8F8FF", "#FAF0FF", "#FFF0F0", "#FFFFFF"]

  ],[0.9,0.95]);

  $.fn.wColorPicker.mixedColors_pre = wColorPickerSaturationValueMapper([
  ...
  $.fn.wColorPicker.simpleColors = wColorPickerSaturationValueMapper([
    ['#000000' , '#333333'], ['#666666' , '#999999'], ['#CCCCCC' , '#FFFFFF'], ['#FF0000', '#00FF00'], ['#0000FF', '#FFFF00'], ['#00FFFF', '#FF00FF']
  ],[0.55,0.95]);
	
  $.fn.wColorPicker.skintoneColors = wColorPickerSaturationValueMapper([
    ['#F0DDC3', '#EAB69C', '#F0DDD0', '#F7CEB5', '#EEBB99'],
    ['#F0D0B6', '#EAA98F', '#DDA98F', '#F7D9D6', '#E2C7B3'],
    ['#F7C39C', '#DDA982', '#EAD0B6', '#F0BAAD', '#A6958D'],
    ['#F0DDB6', '#EAC3A9', '#EAB69C', '#D4806B', '#9E8B82'],
    ['#EAB68F', '#F7D0C3', '#F7B69C', '#EBB285'],
    ['#F7C3A9', '#F7D0B6', '#F0C3A9', '#C3744D'],
    ['#F0D0A9', '#EAC3B6', '#F0A982', '#452A1D'],
    ['#F7D0A9', '#F7DDC3', '#F0B68F', '#ECDDCA']
  ],[0.55,0.95]);
})(jQuery);
